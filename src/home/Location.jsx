      ...
      <div className="max-w-7xl mx-auto">
        <div className="pt-16">
          ...
          <p className="text-lg mx-auto text-center tracking-wide text-black max-w-[750px]">
            ...
            comfortable and welcoming space for you to relax and enjoy a
            delicious meal. Whether you're catching up with friends or
            celebrating a special occasion, our (describe the style - casual,
            elegant, etc.) atmosphere is perfect for any gathering.
          </p>
        </div>
        <div className="pt-16">
