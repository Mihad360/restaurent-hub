      ...
      <div className="flex items-center justify-center gap-20">
        ...
        <div className="max-w-lg">
          <h1 className="text-3xl font-bold pb-4 uppercase">
            Elevating the most delicious <span className="text-amber-600">chicken meal</span>
          </h1>
          <p className="text-lg text-black">
            ...
            textures, all in one amazing bite. We don't just do noodles, we make
            them incredible! Come try them for yourself!
          </p>
        </div>
      </div>
    </div>
